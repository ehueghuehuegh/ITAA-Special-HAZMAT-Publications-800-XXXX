			...
			\subsection{RSSCBA Trait Charts}
				\subsubsection{Respirator Facepieces Chart}
					\begin{tabular}{|p{1cm}||p{7.5cm}|p{2.5cm}|p{1.135cm}|}
						\hline
						Types & Traits & Port Count & IDM \\\hline
				...
				\subsubsection{SCBA Gas Cylinders Chart}
					\begin{tabular}{|p{2cm}||p{8cm}|p{1cm}|p{1.135cm}|}
						\hline
						Types & Traits & IDC & IDM \\\hline
						HD-Hi & Hi-Pressure & \cellcolor[HTML]{700000} & $\Lambda$ \\
						HD-Lo & Lo-Pressure & \cellcolor[HTML]{AA0000} & $\Sigma$ \\
						MD-Hi & Hi-Pressure & \cellcolor[HTML]{707000} & $\lambda$ \\
						MD-Lo & Lo-Pressure & \cellcolor[HTML]{AA7000} & $\sigma$ \\
						SD-Hi & Hi-Pressure & \cellcolor[HTML]{70AA00} & I \\
						SD-Lo & Lo-Pressure & \cellcolor[HTML]{AAAA00} & O \\\hline
					\end{tabular}
				...
				\begin{tabular}{|p{1cm}||p{3cm}|p{7cm}|p{1.135cm}|}
					...
					XS & 50cm - 57cm & A $\rightarrow$ 45cm - 50cm|B $\rightarrow$ 40cm - 45cm & 1 \\
					S & 57cm - 60cm & A $\rightarrow$ 50cm - 55cm|B $\rightarrow$ 45cm - 50cm & 2 \\
					M & 60cm - 63cm & A $\rightarrow$ 55cm - 60cm|B $\rightarrow$ 50cm - 55cm & 3 \\
					L & 63cm - 67cm & A $\rightarrow$ 60cm - 65cm|B $\rightarrow$ 55cm - 60cm & 4 \\
					XL & 67cm - 70cm & A $\rightarrow$ 65cm - 70cm|B $\rightarrow$ 60cm - 65cm & 5 \\\hline
				\end{tabular} \\
