...
\begin{document}
	...
	{\raggedleft
		...
		\section{Respirator / SCBA Identification}
		
		\newpage
		
		\section{Other}\-\\
		\subsection{Copyright}
		Theese fictional fan documents of the White Knuckle universe may not be:
		redistributed, changed or used for commercaly without explicit permission 
		from the author.
