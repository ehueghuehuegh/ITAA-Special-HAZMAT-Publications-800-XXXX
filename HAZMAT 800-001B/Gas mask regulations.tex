		...
		\section{RSSCBA Identification}
			...
			\subsection{RSSCBA Trait Charts}
				...
				\begin{tabular}{|p{1cm}||p{10cm}|p{1.57cm}|}
					...
					5 &  &  \\\hline
				\end{tabular} \\
				\small *If the design falls short of these standards, the BoD may be advised in order to evaluate if the respirator is still production-worthy. \normalsize \\ \-\\
