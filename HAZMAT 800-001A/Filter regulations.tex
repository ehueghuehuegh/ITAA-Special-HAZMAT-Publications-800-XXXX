...
\begin{document}
		...
		\subsection{Filter Trait Charts}
			\subsubsection{Inserts Chart}
				...
				\begin{tabular}{|p{1cm}||p{10cm}|p{1.57cm}|}
					\hline
					Types & Description & Colors \\\hline
	...
	\section{Main filter types} \-\\
		\subsection{Main Filter Types}
			...
			\subsubsection{Main Filter Type Chart}
				...
				\end{tabular} \\ \-\\
				\small *Do note that these are the expected durations, and can be exceeded, however if the design falls short of these standards, the BoD may be advised in order to evaluate if the respirator is still production-worthy. \normalsize \\ \-\\	
	...
	\begin{figure}[b]
		\centering
		\includegraphics[width=5cm, height=5cm]{D:/4TeX/ITAA-Special-HAZMAT-Publications-800-XXXX/images/itaa2}
